...
import com.jiao.bean.TrafficPageViewBean;
...
/**
 * @Package com.jiao.dws.app.DwsTrafficVcChArIsNewPageViewWindow
 * @Author xinyi.jiao
 * @Date 2025/4/15 10:05
...
//        1> TrafficPageViewBean(stt=, edt=, cur_date=, vc=v2.1.134, ch=oppo, ar=21, isNew=1, uvCt=0, svCt=0, pvCt=1, durSum=8053, ts=1744007276534)
        ...
        reduceDS //在向Doris写数据前，将流中统计的实体类对象转换为json格式字符串
