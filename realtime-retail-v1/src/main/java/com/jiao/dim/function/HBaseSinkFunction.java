package com.jiao.dim.function;

import com.alibaba.fastjson.JSONObject;
import com.jiao.bean.TableProcessDim;
...
/**
 * @Package com.jiao.dim.function.HBaseSinkFunction
 * @Author xinyi.jiao
...
public class HBaseSinkFunction extends RichSinkFunction<Tuple2<JSONObject, TableProcessDim>> {
    ...
    @Override
    public void invoke(Tuple2<JSONObject, TableProcessDim> tup, SinkFunction.Context context) throws Exception {
