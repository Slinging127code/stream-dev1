...
public abstract class BaseApp {
    public void start(int parallelism, String ckAndGroupId, String topic) throws Exception {
        //TODO 1.基本环境准备
        //1.1 指定流处理环境
...
//        env.getCheckpointConfig().setCheckpointStorage("hdfs://hadoop102:8020/ck/" + ckAndGroupId);
        ...
        KafkaSource<String> source = KafkaSource.<String>builder()
                ...
                .build();
        //3.3 消费数据 封装为流
        DataStreamSource<String> kafkaStrDS = env.fromSource(source, WatermarkStrategy.noWatermarks(), "Kafka_Source");
        //TODO 4.处理逻辑
